 ...
 *
 * <p>Though this seems attract it might hide certain integrity issues. For example if you delete an
 ...
 */
public abstract class AbstractMongoCrudCollectionDataProvider<R, T, S>
    extends AbstractMongoCollectionDataProvider<S> implements CrudDataProvider<R, T> {

  protected AbstractMongoCrudCollectionDataProvider(
      final String dataset,
      final String datasource,
      final MongoDatabase mongoDatabase,
      final String collectionName,
      final Class<S> pojoClazz) {
