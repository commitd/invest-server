...
public final class GeoUtils {
  ...
  public static Optional<QueryBuilder> createGeoShapeQuery(final String field, final GeoBox box) {
    final CoordinatesBuilder shell =
  ...
  public static Optional<QueryBuilder> createGeoShapeQuery(
      final String field, final ShapeBuilder shape) {
    try {
      return Optional.of(QueryBuilders.geoShapeQuery(field, shape));
