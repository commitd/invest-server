...
public class AbstractSpringDataMongoRepositoryDataProviderTest {
  ...
  public void test() {
    ...
    final AbstractSpringDataMongoRepositoryDataProvider<Object, String, ReactiveCrudRepository<Object, String>> dp =
        new AbstractSpringDataMongoRepositoryDataProvider("dataset", "datasource", mongo, repo) {
