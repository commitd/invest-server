...
public class SpringDataElasticsearchSupportServiceTest {
  ...
  public void before() {
    ...
    sdess = new SpringDataElasticsearchSupportService<>(mapper, elasticsearchTemplate, INDEX, TYPE, Entity.class);
  }
  ...
  public void testQuery() {
    ...
    doReturn("results").when(elasticsearchTemplate).query(ArgumentMatchers.any(SearchQuery.class),
