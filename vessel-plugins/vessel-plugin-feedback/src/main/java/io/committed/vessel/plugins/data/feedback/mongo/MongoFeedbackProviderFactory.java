...
public class MongoFeedbackProviderFactory
  ...
  public MongoFeedbackProviderFactory() {
    super("vessel-mongo-feedback", FeedbackDataProvider.class, DatabaseConstants.MONGO);
  }

  @Override
  public Mono<FeedbackDataProvider> build(final String dataset, final String datasource,
      final Map<String, Object> settings) {
    // TODO move the functionality from the ketos abstract mongo factories to vessel-data-mongo
