 ...
 *
 * <p>This is useful for development and testing,
 *
 * <p>It sets up three accounts: admin, dev, and user with corresponding roles of the same name. The
  ...
  public UserAccountRepository userDetailsRepository(final PasswordEncoder passwordEncoder) {
    ...
    final UserAccount user =
        UserAccount.builder()
            ...
            .authorities(Sets.newHashSet(InvestRoles.USER_AUTHORITY))
            .build();
    final UserAccount admin =
        UserAccount.builder()
            .username("admin")
            .password(passwordEncoder.encode("admin"))
            .authorities(Sets.newHashSet(InvestRoles.ADMINISTRATOR_AUTHORITY))
            .build();
    final UserAccount dev =
        UserAccount.builder()
            .username("dev")
            .password(passwordEncoder.encode("dev"))
            .authorities(Sets.newHashSet(InvestRoles.DEV_AUTHORITY))
            .build();
    final UserAccount devadmin =
        UserAccount.builder()
            .username("devadmin")
            .password(passwordEncoder.encode("devadmin"))
            .authorities(
                Sets.newHashSet(InvestRoles.DEV_AUTHORITY, InvestRoles.ADMINISTRATOR_AUTHORITY))
            .build();
    final UserAccount devuser =
        UserAccount.builder()
            .username("devuser")
            .password(passwordEncoder.encode("devuser"))
            .authorities(
                Sets.newHashSet(InvestRoles.DEV_AUTHORITY, InvestRoles.ADMINISTRATOR_AUTHORITY))
            .build();
