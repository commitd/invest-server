 ...
 *
 * <p>This is only useful as a stub that a development UI can hit. We can't really perform the
 * actions or deal with UI state properly but at
 *
 * <p>Note the queries names are slightly different (if nothing else they have a PREFIX). ideally
