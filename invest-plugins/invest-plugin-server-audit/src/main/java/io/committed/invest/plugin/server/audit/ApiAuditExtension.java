 ...
 *
 * Two implemenation are included and controlled by Springs profiles. These are simple
 ...
 * environment). It is likely that in a production environment a custom implementation of
 * {@link AuditService} would be created.
 */
@Configuration
