 ...
 * An Invest dataset.
 *
 * <p>An Invest dataset represents a collection of datas provider which Invest considers as a single
 * data.
 *
 * <p>The providers might all come from the same datasource or they might be from different original
 ...
 *
 * <p>For example, an applicaiton might have a display news. One instance of it may which to have a
...
public class Dataset {
  ...
  @Builder.Default private List<DataProviderSpecification> providers = Collections.emptyList();
}
