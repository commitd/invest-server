 ...
 *
 * Typically this is used for offering functionality such as authentication, or some common service
 * layer used by multiple plugins.
 *
 * You should spilt your service into an JAR file of interfaces which other can depend on, and
