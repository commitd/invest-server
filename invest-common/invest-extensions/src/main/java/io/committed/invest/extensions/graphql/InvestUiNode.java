 ...
 *
 * <p>Use this in your @GraphQLContext in order to extend the ui node.
 *
 * <p>The Invest UI has its own graphQL resolvers, which are hosted purely in the UI. However in
 * same cases (eg development or testing) we want to offer a server side implementation of thsoe
 * functions.
 *
 * <p>This should mirror the functionality available on the UI as best it can. And impleemnt the
