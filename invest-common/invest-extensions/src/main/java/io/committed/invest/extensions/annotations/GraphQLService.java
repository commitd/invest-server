 ...
 *
 * <p>Use this annotation in preference to @Service when creating services which have GraphQL (SQR)
 * functions, ie functions annotated themselves with @GraphQLQuery or @GraphQLMutation.
 *
 * <p>When the GraphQL endpoint is set up only instances with this annotation will be merged to form
